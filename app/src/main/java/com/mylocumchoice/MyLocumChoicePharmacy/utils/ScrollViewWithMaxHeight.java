...
public class ScrollViewWithMaxHeight extends ScrollView {
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            TypedArray styledAttrs = context.obtainStyledAttributes(attrs, R.styleable.ScrollViewWithMaxHeight);
            //200 is a defualt value
            maxHeight = styledAttrs.getDimensionPixelSize(R.styleable.ScrollViewWithMaxHeight_maxHeight, defaultHeight);
