...
public class PendingShiftsAdapter extends RecyclerView.Adapter<PendingShiftsAdapter.ViewHolder>{

    List<AppliedShiftResponse.Shift> lv_shifts;
    Context mContext;
    ListItemClickListener mListener;
    public PendingShiftsAdapter(Context mContext, List<AppliedShiftResponse.Shift> lv_shifts, ListItemClickListener mListener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        final PendingShiftsAdapter.ViewHolder vh = new PendingShiftsAdapter.ViewHolder(v);
        return vh;
    }
